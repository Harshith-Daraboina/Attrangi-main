...
export default function CaregiverPaymentsScreen({ navigation }) {
              ...
              <View key={payment.id} style={styles.paymentCard}>
                <View style={styles.paymentHeader}>
                  <View style={styles.paymentInfo}>
                    ...
                    <Text style={styles.therapistName}>with {payment.therapist}</Text>
          ...
          <View style={styles.methodCard}>
            <View style={styles.methodInfo}>
              ...
              <View style={styles.methodDetails}>
                <Text style={styles.methodType}>Credit Card</Text>
                <Text style={styles.methodNumber}>****1234</Text>
                <Text style={styles.methodExpiry}>Expires 12/25</Text>
              </View>
            </View>
