  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        <CircularProgress progress={3} total={4} size={50} strokeWidth={3} />
      </View>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.title}>
            Personalized resources & assessment
          </Text>
          <Text style={styles.subtitle}>
            Get tailored recommendations and track your progress with our advanced assessment tools
          </Text>
        </View>
