  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        <CircularProgress progress={1} total={4} size={50} strokeWidth={3} />
      </View>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.title}>
            Your wellbeing & growth companion
          </Text>
          <Text style={styles.subtitle}>
            Start your mental health journey with personalized support and professional guidance
          </Text>
        </View>
