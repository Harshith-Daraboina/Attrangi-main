...
export default function TherapistCommunityScreen({ navigation }) {
  ...
  const groups = [
    {
      ...
      members: 456,
      lastMessage: 'New research on CBT techniques',
    ...
    {
      id: 2,
      name: 'Therapy Techniques Discussion',
      members: 234,
      lastMessage: 'Has anyone tried EMDR recently?',
    ...
    },
    {
      ...
      members: 189,
      lastMessage: 'Latest studies on depression treatment',
    ...
    {
      id: 4,
      name: 'Therapist Self-Care',
      members: 156,
      lastMessage: 'Managing burnout in private practice',
  ...
  const recentMessages = [
    {
      id: 1,
      sender: 'Dr. Maria L.',
      message: 'I found this new CBT technique really effective for anxiety',
      time: '15 min ago',
      isOwn: false,
    },
    {
      id: 2,
      sender: 'You',
      message: 'Thanks for sharing! I\'ll try it with my patients',
      time: '12 min ago',
      isOwn: true,
    },
    {
      id: 3,
      sender: 'Dr. John R.',
      message: 'Has anyone used virtual reality in therapy sessions?',
      time: '30 min ago',
      isOwn: false,
    },
    {
      id: 4,
      sender: 'Dr. Sarah K.',
      message: 'I\'ve been using VR for exposure therapy, great results!',
      time: '25 min ago',
      isOwn: false,
    },
  ];

  const categories = ['All', 'Professional', 'Clinical', 'Research', 'Wellness', 'General'];
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Professional Community</Text>
        <TouchableOpacity>
          ...
          <View style={styles.groupsContainer}>
            {filteredGroups.map((group) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('ChatTherapist', { groupId: group.id })}
              >
