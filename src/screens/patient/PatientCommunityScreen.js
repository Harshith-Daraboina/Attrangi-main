...
export default function PatientCommunityScreen({ navigation }) {
  ...
  const groups = [
    ...
    },
    {
      ...
      members: 189,
      lastMessage: 'Great meditation session today!',
    ...
    },
    {
      ...
      members: 298,
      lastMessage: 'Here are some breathing techniques...',
  ...
  const recentMessages = [
    {
      id: 1,
      sender: 'Sarah M.',
      message: 'I found this breathing exercise really helpful',
      time: '10 min ago',
      isOwn: false,
    },
    {
    ...
    },
    {
      id: 3,
      sender: 'Mike R.',
      message: 'Has anyone tried the new meditation app?',
      time: '15 min ago',
      isOwn: false,
    },
    {
      id: 4,
      sender: 'Lisa K.',
      message: 'I\'ve been using it for a week, it\'s great!',
      time: '12 min ago',
      isOwn: false,
    },
  ];

  const categories = ['All', 'Anxiety', 'Depression', 'Mindfulness', 'Stress', 'General'];
          ...
          <View style={styles.groupsContainer}>
            {filteredGroups.map((group) => (
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('ChatPatient', { groupId: group.id })}
              >
